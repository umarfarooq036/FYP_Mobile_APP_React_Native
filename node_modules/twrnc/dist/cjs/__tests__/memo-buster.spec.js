...
(0, globals_1.describe)(`memo busting`, () => {
    ...
    const Component = ({ initial }) => {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(react_native_1.TouchableOpacity, { onPress: () => toggleColorScheme() },
                react_1.default.createElement(react_native_1.Text, null, "toggle scheme")),
    ...
    (0, globals_1.it)(`breaks memoization properly, starting "light"`, () => {
        ...
        (0, globals_1.expect)(assertArray(renderer.toJSON()).slice(1)).toEqual([
            `no-match:dark`,
            `memo:no-match:dark`,
            `memo:no-match:dark`,
        ]);
        react_test_renderer_1.default.act(() => {
            renderer.root.findByType(react_native_1.TouchableOpacity).props.onPress();
        });
        (0, globals_1.expect)(assertArray(renderer.toJSON()).slice(1)).toEqual([
            `match:dark`,
