...
exports.removeOpacityHelpers = exports.colorOpacity = exports.color = void 0;
...
function findColorInConfigRecursive(colorName, config) {
    ...
    if ((0, types_1.isString)(configColor)) {
        return configColor;
    }
    else if ((0, types_1.isObject)(configColor) && (0, types_1.isString)(configColor.DEFAULT)) {
